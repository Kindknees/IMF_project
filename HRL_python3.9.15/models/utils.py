...
# from sknetwork.utils import edge2list
...
def edge2list(edges: np.ndarray, undirected: bool = True) -> sparse.csr_matrix:
    """
    ...
    -----------
    edges: np.ndarray
        Array of shape (n_edges, 2) containing the edges
    undirected: bool, default=True
        If True, make the matrix symmetric
...
def get_sub_adjacency_matrix(line_to_sub_id_tuple: Tuple[List, List], rho: np.array = None,
    ...
    adj = edge2list(edge_list, undirected=True).todense()
