...
from gymnasium.spaces import Box, Discrete, Dict # needed for adding connectivity matrix
...
class SubstationGreedyEnv(CustomGymEnv):
    ...
    def step(self, gym_action):
        ...
        g2op_obs, reward, terminted, truncated, info = self.init_env.step(g2op_act)
...
class HierarchicalGridGym(MultiAgentEnv):
    ...
    def _low_level_step(self, action):
        ...
        f_done = f_terminated or f_truncated
